    ...
    return (
        <div className="container mx-auto p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Link
                    to={`/product/${lock.id}`}
                    className="text-blue-600 hover:underline bg-blue-600"
                >
                    <div className={'bg-blue-600'}>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex items-center gap-3">
                                <div
                                    className="w-6 h-6 bg-black rounded-full cursor-pointer border-2 border-gray-300"></div>
                                <div
                                    className="w-6 h-6 bg-gray-300 rounded-full cursor-pointer border-2 border-gray-300"></div>
                                <div
                                    className="w-6 h-6 bg-yellow-500 rounded-full cursor-pointer border-2 border-gray-300"></div>
                            </div>
                        </div>
